...
export const DEFAULT_QOL_SETTINGS=Object.freeze({
  version:1,
  gameplay:{combatMessages:'full',firstTimeHints:true,holdConfirm:true,quickRestartKey:'Backspace',hubCamera:'drag',hubCameraSensitivity:1},
