# Validation — Prototype 2.9A.27.2

Passed static and targeted checks:

- 81 JavaScript files passed `node --check`.
...
- `index.html` uses one release cache ID: `29a27p2-roadside-map-smoke-20260730`.
...
Headless Chromium did not complete in the execution environment. The roadside loss menu, controller focus, live map readability, and the complete browser suite still require a real Safari/Chrome playthrough.
