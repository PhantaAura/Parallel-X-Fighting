"use strict";
import {FIGHTER_META,FIGHTER_STATUS,PLAYABLE_ROSTER_IDS,ROSTER,ROSTER_IDS,isMirrorMatch} from './roster.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {STAGES,drawStage} from './stages.js';
import {CUSTOM_CONTROLLER_ACTIONS} from './input.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {sharedInput as input} from './input-runtime.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {decideCPU} from './ai.js';
import {TimerRegistry,clamp,resetCombo} from './combat.js';
import {EffectSystem} from './effects.js';
import {Fighter} from './fighter.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
...
import {TouchControls} from './touch-controls.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {TouchSettingsPanel,createDefaultTouchSettings} from './touch-layout-editor.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {FighterVisuals,availableRrvvfoAppearances,isDeveloperSpriteBuild,loadRrvvfoVisualSettings,normalizeRrvvfoAppearance,shouldShowRrvvfoLoadFailure} from './fighter-visuals.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {SpriteDebugViewer} from './sprite-debug-viewer.js';
import {ControllerManager} from './controller-manager.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {BUILD_VERSION} from './build-info.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {initializeStoryPolish} from './story/story-polish.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {initializeStoryCharm} from './story/story-charm.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
...
import {loadQolSettings,saveQolSettings} from './qol-settings.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {NotificationSystem} from './notification-system.js';
import {adaptiveMoveList,renderAdaptiveMoveList} from './move-list.js';
import {SettingsPanel} from './settings-panel.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {importSaveText,resetSaveGroup,stringifySave} from './save-manager.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
...
import {cooldownText,fighterHudModel} from './hud-model.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {AbilityHotbar} from './ability-hotbar.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {loadAbilityHotbarSettings,saveAbilityHotbarSettings} from './ability-hotbar-data.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {ResponsiveGameLayout} from './responsive-game-layout.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {OrientationManager,loadMobilePresentationSettings,saveMobilePresentationSettings} from './orientation-manager.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
import {FullscreenManager} from './fullscreen-manager.js?v=29a4072r-ch1-adventure-playtestlab-20260802';
...
function handleSettingsAction(action){
  ...
  if(action==='resetHubCamera'){import('./story/hub-camera.js?v=29a4072r-ch1-adventure-playtestlab-20260802').then(({resetAllHubCameras})=>{resetAllHubCameras();notifications.push('HUB CAMERA RESET',{important:true,key:'camera-reset'})});return}
...
async function startGameInternal(){
  ...
  try{
    ...
    if(['cpu','local'].includes(requestedMode)){
      ...
      const {startConfiguredArenaBattle}=await import('./arena/arena-mode.js?v=29a4072r-ch1-adventure-playtestlab-20260802');
      saveLastActivity();
