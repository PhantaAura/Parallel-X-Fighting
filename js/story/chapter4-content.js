...
export const CHAPTER4_STATE_VERSION=1;
...
export function freshChapter4State(){
  return{
    ...
    ryuzankaro:{available:false,started:false,ingredients:[],bossDefeated:false,skipped:false,phase:'idle'},
    rewards:{lensMastery:0,vibrationSense:false,objectSwapRange:0,teamBadge:false,ryuzankaroCodex:false},
    hollowWatcher:{defeated:false,patternsRecorded:0},
