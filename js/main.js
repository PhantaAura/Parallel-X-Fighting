...
hit(dmg,k=0,type='hit'){
  ...
  if(this.inv)return;if(this.armor)dmg*=.55;dmg/=this.c.d;if(this.id==='alt'&&this.hp<35)dmg*=.86;if(this.block&&type!=='seal'){dmg*=.28;k*=.25;this.en=clamp(this.en+4,0,100)}if(this.trap)dmg*=1.35;this.hp=clamp(this.hp-dmg,0,100);this.vx=k;this.stun=this.block?5:12;burst(this.x+24,this.y+43,this.c.a,14);sound(this.block?120:70,.07);shake=Math.max(shake,this.block?3:7)}
