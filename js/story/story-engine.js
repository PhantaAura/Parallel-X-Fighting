import {ArenaBattle,resetArenaBattleInstance} from '../arena/arena-mode.js?v=29a4071-chapter3-sabotage-investigation-20260802';
import {sharedInput} from '../input-runtime.js?v=29a4071-chapter3-sabotage-investigation-20260802';
import {SonicBattleDialogue} from '../sonic-battle-dialogue.js?v=29a4071-chapter3-sabotage-investigation-20260802';
import {applyStoryProgressionToFighter} from './story-progression.js?v=29a4071-chapter3-sabotage-investigation-20260802';

export const STORY_ENGINE_VERSION='2.9A.24';
export const STORY_ENGINE_CACHE='29a4071-chapter3-sabotage-investigation-20260802';
...
export function createStoryBattle({stageId='dojo',opponent=null}={}){
  ...
  battle.allowRandomRematch=false;
...
export class StoryEngineSession{
  ...
  setHotbarAvailability(allowedSlots=[],{show=true}={}){
    // Story exploration/tutorials keep the canonical ability order so scripted Lens/Object Swap prompts can never be invalidated by a combat build.
    this.battle?.refreshPlayerHotbar?.();
