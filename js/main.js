"use strict";
import {FIGHTER_META,FIGHTER_STATUS,PLAYABLE_ROSTER_IDS,ROSTER,ROSTER_IDS,isMirrorMatch} from './roster.js?v=29a27-chapter-hooks-pacing-20260730';
import {STAGES,drawStage} from './stages.js';
import {CUSTOM_CONTROLLER_ACTIONS} from './input.js?v=29a27-chapter-hooks-pacing-20260730';
import {sharedInput as input} from './input-runtime.js?v=29a27-chapter-hooks-pacing-20260730';
import {decideCPU} from './ai.js';
import {TimerRegistry,clamp,resetCombo} from './combat.js';
import {EffectSystem} from './effects.js';
import {Fighter} from './fighter.js?v=29a27-chapter-hooks-pacing-20260730';
...
import {TouchControls} from './touch-controls.js?v=29a27-chapter-hooks-pacing-20260730';
import {TouchSettingsPanel,createDefaultTouchSettings} from './touch-layout-editor.js?v=29a27-chapter-hooks-pacing-20260730';
import {FighterVisuals,availableRrvvfoAppearances,isDeveloperSpriteBuild,loadRrvvfoVisualSettings,normalizeRrvvfoAppearance,shouldShowRrvvfoLoadFailure} from './fighter-visuals.js?v=29a27-chapter-hooks-pacing-20260730';
import {SpriteDebugViewer} from './sprite-debug-viewer.js';
import {ControllerManager} from './controller-manager.js?v=29a27-chapter-hooks-pacing-20260730';
import {BUILD_VERSION} from './build-info.js?v=29a27-chapter-hooks-pacing-20260730';
import {initializeStoryPolish} from './story/story-polish.js?v=29a27-chapter-hooks-pacing-20260730';
import {ConfirmationDialog} from './confirmation-dialog.js';
import {MainMenu} from './main-menu.js?v=29a27-chapter-hooks-pacing-20260730';
import {MatchStatistics} from './match-statistics.js';
import {PauseMenu,simulationCanAdvance} from './pause-menu.js?v=29a27-chapter-hooks-pacing-20260730';
import {ResultsScreen} from './results-screen.js';
import {loadQolSettings,saveQolSettings} from './qol-settings.js?v=29a27-chapter-hooks-pacing-20260730';
import {NotificationSystem} from './notification-system.js';
import {adaptiveMoveList,renderAdaptiveMoveList} from './move-list.js';
import {SettingsPanel} from './settings-panel.js?v=29a27-chapter-hooks-pacing-20260730';
import {importSaveText,resetSaveGroup,stringifySave} from './save-manager.js?v=29a27-chapter-hooks-pacing-20260730';
...
import {cooldownText,fighterHudModel} from './hud-model.js?v=29a27-chapter-hooks-pacing-20260730';
import {AbilityHotbar} from './ability-hotbar.js?v=29a27-chapter-hooks-pacing-20260730';
import {loadAbilityHotbarSettings,saveAbilityHotbarSettings} from './ability-hotbar-data.js?v=29a27-chapter-hooks-pacing-20260730';
import {ResponsiveGameLayout} from './responsive-game-layout.js?v=29a27-chapter-hooks-pacing-20260730';
import {OrientationManager,loadMobilePresentationSettings,saveMobilePresentationSettings} from './orientation-manager.js?v=29a27-chapter-hooks-pacing-20260730';
import {FullscreenManager} from './fullscreen-manager.js?v=29a27-chapter-hooks-pacing-20260730';
import {loadLostYearProgress,modeUnlockedForProgress,modeUnlockRequirement} from './story/lost-year-data.js?v=29a27-chapter-hooks-pacing-20260730';
...
function handleSettingsAction(action){
  ...
  if(action==='resetHubCamera'){import('./story/hub-camera.js?v=29a27-chapter-hooks-pacing-20260730').then(({resetAllHubCameras})=>{resetAllHubCameras();notifications.push('HUB CAMERA RESET',{important:true,key:'camera-reset'})});return}
