...
export function resetTrainingWorld(world){
  world.timers.cancelAll();world.projectiles.length=0;world.effects.clear();clearClash(world);clearCinematic(world);world.shake=0;world.hitstop=0;trainingState.afterFirstHit=false;trainingState.forceNextClash=false;
