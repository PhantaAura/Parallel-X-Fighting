...
// Keep the history dense: assigning length=10 after the first input creates nine
// empty rows in the Training HUD.
export function recordInput(label){trainingState.inputHistory.unshift(label);if(trainingState.inputHistory.length>10)trainingState.inputHistory.length=10}
