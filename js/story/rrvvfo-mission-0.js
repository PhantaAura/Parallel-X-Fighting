import {ArenaBattle,resetArenaBattleInstance} from '../arena/arena-mode.js?v=25c6-animated-sage';
...
#${UI_ID} .dialogueWrap{position:absolute;inset:0;display:grid;align-items:end;padding:18px 18px 26px;background:linear-gradient(transparent 58%,#00000052);pointer-events:auto}
#${UI_ID} .dialogueWrap.hidden{display:none}
#${UI_ID} .sonicDialogueBox{--speaker:#303748;position:relative;display:grid;grid-template-columns:104px minmax(0,1fr);gap:12px;align-items:center;width:min(900px,calc(100vw - 36px));min-height:116px;margin:0 auto;padding:8px 14px 8px 8px;border:6px solid #090909;border-radius:2px;background:#f7f7f4;color:#111;box-shadow:0 5px 0 #090909;text-align:left;cursor:pointer;pointer-events:auto}
#${UI_ID} .dialogueWrap[data-speaker="RRVVFO"] .sonicDialogueBox{--speaker:#a52f27}
#${UI_ID} .sonicDialogueBox:focus-visible{outline:4px solid #6bbcff;outline-offset:5px}
#${UI_ID} .dialoguePortrait{width:96px;height:96px;align-self:center;border:4px solid #090909;background:#263550 url('./assets/story/portraits/sage.png?v=25c6') center bottom/contain no-repeat;image-rendering:pixelated;overflow:hidden}
#${UI_ID} .dialogueWrap[data-speaker="RRVVFO"] .dialoguePortrait{background-color:#74251f;background-image:url('./assets/story/portraits/rrvvfo.png?v=25c6')}
#${UI_ID} .dialogueCopy{position:relative;min-width:0;min-height:92px;padding:27px 42px 16px 4px}
#${UI_ID} .speakerTab{position:absolute;left:-2px;top:-15px;min-width:168px;padding:5px 12px;border:4px solid #090909;background:var(--speaker);color:#fff;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;font-weight:1000;letter-spacing:.08em;text-align:center;box-shadow:3px 3px 0 #090909}
#${UI_ID} .dialogueText{display:block;min-height:52px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:18px;font-weight:800;line-height:1.38;white-space:pre-wrap}
#${UI_ID} .dialoguePrompt{position:absolute;right:3px;bottom:0;color:#666;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:8px;font-weight:900;letter-spacing:.08em}
#${UI_ID} .advanceArrow{position:absolute;right:7px;bottom:18px;width:0;height:0;border-top:10px solid transparent;border-bottom:10px solid transparent;border-left:16px solid #1689db;filter:drop-shadow(2px 2px 0 #080808);animation:m0Arrow .75s steps(2,end) infinite}
...
@media(max-width:620px){#${UI_ID} .dialogueWrap{padding:10px 10px 20px}#${UI_ID} .sonicDialogueBox{grid-template-columns:76px minmax(0,1fr);min-height:98px;padding:6px 9px 6px 6px;gap:8px;border-width:5px}#${UI_ID} .dialoguePortrait{width:70px;height:82px;border-width:3px}#${UI_ID} .dialogueCopy{min-height:82px;padding:23px 30px 12px 0}#${UI_ID} .speakerTab{top:-12px;min-width:122px;padding:4px 8px;font-size:10px;border-width:3px}#${UI_ID} .dialogueText{min-height:48px;font-size:14px}#${UI_ID} .advanceArrow{right:5px;bottom:16px;border-top-width:8px;border-bottom-width:8px;border-left-width:13px}#${UI_ID} .missionTag{top:128px}#${UI_ID} .completeCard h2{font-size:32px}}
`;
...
class RrvvfoMission0{
  ...
  start(){
    ...
    this.battle.root.querySelector('[data-fighter-name2]').textContent='THE SAGE';
    this.patchBattle();
    this.battle.start();
    this.battle.root.classList.add('storyMission0','sageOpponent');
    this.battle.root.querySelector('[data-stage-name]').textContent='SAGE TRAINING FIELD';
    this.battle.root.querySelector('.badge strong').textContent='PROTOTYPE 2.5C6 • RRVVFO MISSION 0';
