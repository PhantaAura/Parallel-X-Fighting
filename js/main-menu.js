...
export const MAIN_MENU_MODES=Object.freeze([
  {id:'story',label:'STORY MODE',description:'Experience the Parallels X campaign foundation.',players:'1',availability:'Story foundation available; The Lost Year comes later.'},
