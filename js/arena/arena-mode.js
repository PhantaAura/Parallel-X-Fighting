...
import {clampToStage,getArenaStage,listArenaStages,outsideStageProjectileBounds,stageWallAvoidance} from './arena-stages.js?v=29a24p4-validation-sync-20260730';
import {drawArenaStage} from './arena-stage-renderer.js';
import {WebGLArenaRenderer} from './webgl-renderer.js';
import {ArenaControlManager} from './arena-controls.js?v=29a24p4-validation-sync-20260730';
import {ABILITY_CATEGORY,ARENA_NORMAL_PROFILES,SPECIAL_CATEGORIES,abilityCategory,abilityTiming,arenaAttackFor} from './arena-combat-data.js?v=29a24p4-validation-sync-20260730';
import {ROSTER} from '../roster.js?v=29a24p4-validation-sync-20260730';
import {COMBAT_RULES,difficultyProfile,decayHabit} from '../combat-core.js?v=29a24p4-validation-sync-20260730';
