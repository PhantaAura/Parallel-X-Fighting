import {ArenaBattle,resetArenaBattleInstance} from '../arena/arena-mode.js?v=29a361-chapter4-replay-overlay-fix-20260801';
import {sharedInput} from '../input-runtime.js?v=29a361-chapter4-replay-overlay-fix-20260801';
import {SonicBattleDialogue} from '../sonic-battle-dialogue.js?v=29a361-chapter4-replay-overlay-fix-20260801';
import {applyStoryProgressionToFighter} from './story-progression.js?v=29a361-chapter4-replay-overlay-fix-20260801';

export const STORY_ENGINE_VERSION='2.9A.24';
export const STORY_ENGINE_CACHE='29a361-chapter4-replay-overlay-fix-20260801';
