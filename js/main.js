"use strict";
import {FIGHTER_META,FIGHTER_STATUS,PLAYABLE_ROSTER_IDS,ROSTER,ROSTER_IDS,isMirrorMatch} from './roster.js?v=29a7-casual-retention-20260729';
import {STAGES,drawStage} from './stages.js';
import {CUSTOM_CONTROLLER_ACTIONS} from './input.js?v=29a7-casual-retention-20260729';
import {sharedInput as input} from './input-runtime.js?v=29a7-casual-retention-20260729';
import {decideCPU} from './ai.js';
import {TimerRegistry,clamp,resetCombo} from './combat.js';
import {EffectSystem} from './effects.js';
import {Fighter} from './fighter.js?v=29a7-casual-retention-20260729';
...
import {TouchControls} from './touch-controls.js?v=29a7-casual-retention-20260729';
import {TouchSettingsPanel,createDefaultTouchSettings} from './touch-layout-editor.js?v=29a7-casual-retention-20260729';
import {FighterVisuals,availableRrvvfoAppearances,isDeveloperSpriteBuild,loadRrvvfoVisualSettings,normalizeRrvvfoAppearance,shouldShowRrvvfoLoadFailure} from './fighter-visuals.js?v=29a7-casual-retention-20260729';
import {SpriteDebugViewer} from './sprite-debug-viewer.js';
import {ControllerManager} from './controller-manager.js?v=29a7-casual-retention-20260729';
import {BUILD_VERSION} from './build-info.js?v=29a7-casual-retention-20260729';
import {ConfirmationDialog} from './confirmation-dialog.js';
import {MainMenu} from './main-menu.js?v=29a7-casual-retention-20260729';
import {MatchStatistics} from './match-statistics.js';
import {PauseMenu,simulationCanAdvance} from './pause-menu.js?v=29a7-casual-retention-20260729';
import {ResultsScreen} from './results-screen.js';
import {loadQolSettings,saveQolSettings} from './qol-settings.js?v=29a7-casual-retention-20260729';
import {NotificationSystem} from './notification-system.js';
import {adaptiveMoveList,renderAdaptiveMoveList} from './move-list.js';
import {SettingsPanel} from './settings-panel.js?v=29a7-casual-retention-20260729';
import {importSaveText,resetSaveGroup,stringifySave} from './save-manager.js?v=29a7-casual-retention-20260729';
...
import {cooldownText,fighterHudModel} from './hud-model.js?v=29a7-casual-retention-20260729';
import {AbilityHotbar} from './ability-hotbar.js?v=29a7-casual-retention-20260729';
import {loadAbilityHotbarSettings,saveAbilityHotbarSettings} from './ability-hotbar-data.js?v=29a7-casual-retention-20260729';
import {ResponsiveGameLayout} from './responsive-game-layout.js?v=29a7-casual-retention-20260729';
import {OrientationManager,loadMobilePresentationSettings,saveMobilePresentationSettings} from './orientation-manager.js?v=29a7-casual-retention-20260729';
import {FullscreenManager} from './fullscreen-manager.js?v=29a7-casual-retention-20260729';
