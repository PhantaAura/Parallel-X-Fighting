...
export const DEFAULT_QOL_SETTINGS=Object.freeze({
  version:1,
  gameplay:{combatMessages:'full',firstTimeHints:true,holdConfirm:true,quickRestartKey:'Backspace'},
...
export function sanitizeQolSettings(value={}){
  ...
  next.gameplay={...next.gameplay,...source.gameplay,combatMessages:enumValue(source.gameplay?.combatMessages,['full','important','off'],'full'),firstTimeHints:bool(source.gameplay?.firstTimeHints,true),holdConfirm:bool(source.gameplay?.holdConfirm,true)};
