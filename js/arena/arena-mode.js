...
import {clampToStage,getArenaStage,listArenaStages,outsideStageProjectileBounds,stageProfile,stageWallAvoidance} from './arena-stages.js?v=29a36-playful-exploration-quest-variety-20260801';
import {drawStagePersonality,projectileHitsStageGeometry,resolveStageGeometry,stagePersonalityFor} from './stage-personality.js?v=29a36-playful-exploration-quest-variety-20260801';
import {drawArenaStage} from './arena-stage-renderer.js';
import {WebGLArenaRenderer} from './webgl-renderer.js';
import {ArenaControlManager} from './arena-controls.js?v=29a36-playful-exploration-quest-variety-20260801';
import {ABILITY_CATEGORY,ARENA_NORMAL_PROFILES,SPECIAL_CATEGORIES,abilityCategory,abilityTiming,arenaAttackFor,fighterFeelFor} from './arena-combat-data.js?v=29a36-playful-exploration-quest-variety-20260801';
import {finalKoImpactFor,signatureMeleeKind,signatureProfileFor} from './signature-combat.js?v=29a36-playful-exploration-quest-variety-20260801';
import {PLAYABLE_ROSTER_IDS,ROSTER} from '../roster.js?v=29a36-playful-exploration-quest-variety-20260801';
import {COMBAT_RULES,difficultyProfile,decayHabit} from '../combat-core.js?v=29a36-playful-exploration-quest-variety-20260801';
import {resolveHubWorldCollision} from '../story/hub-collision.js?v=29a36-playful-exploration-quest-variety-20260801';
import {loadQolSettings} from '../qol-settings.js?v=29a36-playful-exploration-quest-variety-20260801';
import {createTrainingTrialState,recordTrainingTrialEvent,resetTrainingTrial,trainingTrialView} from '../training-trials.js?v=29a36-playful-exploration-quest-variety-20260801';
import {PURSUIT_TUNING,canGroundBounce,canWallSplat,dashIdentityFor,pursuitDurationFor,pursuitPromptText,pursuitTechAvailable,pursuitWindowFor} from './pursuit-combat.js?v=29a36-playful-exploration-quest-variety-20260801';
import {FOCUS_RECOVERY_RULES,channelFocusRecovery,endFocusRecovery,focusRecoveryAvailability,interruptFocusRecovery,recoverableHealthView,registerRecoverableDamage,resetFocusRecovery,tickFocusRecovery} from '../focus-recovery.js?v=29a36-playful-exploration-quest-variety-20260801';
