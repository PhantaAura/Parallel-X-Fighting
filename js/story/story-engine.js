import {ArenaBattle,resetArenaBattleInstance} from '../arena/arena-mode.js?v=29a27p2-roadside-map-smoke-20260730';
import {sharedInput} from '../input-runtime.js?v=29a27p2-roadside-map-smoke-20260730';
import {SonicBattleDialogue} from '../sonic-battle-dialogue.js?v=29a27p2-roadside-map-smoke-20260730';
import {applyStoryProgressionToFighter} from './story-progression.js?v=29a27p2-roadside-map-smoke-20260730';

export const STORY_ENGINE_VERSION='2.9A.24';
export const STORY_ENGINE_CACHE='29a27p2-roadside-map-smoke-20260730';
