import {BUILD_VERSION} from './build-info.js?v=25c6';
import {startArenaBattle} from './arena/arena-mode.js?v=25c6-animated-sage';
import {openLostYearStory} from './story/lost-year-story.js?v=25c6-animated-sage';
